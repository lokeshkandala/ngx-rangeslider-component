...
export class RangeSliderComponent implements ControlValueAccessor {
  ...
  private valToPixelFactor: number = 0;
  private minSliderClicked = false;
  maxSliderClicked = false;
  minSliderLeft: number = 0;
  maxSliderLeft: number = 0;
  minSliderIntialLeft: number = 0; 
  intialMinMouseX: number = 0;
  minChange: number = 0;
  maxSliderIntialLeft: number = 0;
  intialMaxMouseX: number = 0;
  maxChange: number = 0;
  minSelected = false;
  maxSelected = false;
  ...
  rangeInPixels: number = 0;
  highlightLeft: number = 0;
  highlightWidth: number = 0;
  minSliderTouched = false;
  sliderHeight:number = 0;
  toolTipTop:number = 0;
  combineToolTipLeft:number = 0;
  minToolTipWidth:number = 0;
  combineToolTipWidth:number = 0;    
...
getlength(num:any): number {
    return  String(num).match(/\d/g)?.length || 0;
}
  getWidth() {
